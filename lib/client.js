...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
    ...
    console.log("------------ ",xmlnsSoap)
    xml = '<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://schemas.ericsson.com/cai3g1.2/">' +
